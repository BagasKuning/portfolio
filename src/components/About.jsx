...
const About = () => {
  ...
  return (
    <div className="px-6 relative" id='about' ref={aboutRef}>
      <p className="text-6xl text-justify relative">
        <span className="about-text" style={{ WebkitTextFillColor: 'transparent', WebkitBackgroundClip: 'text', backgroundImage: `linear-gradient(to bottom, #121314 ${scrollProgress * 100}%, transparent ${scrollProgress * 100}%)` }}>
